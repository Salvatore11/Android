            ...
            Request loginRequest = new JsonObjectRequest(Request.Method.POST, url, params, new Response.Listener<JSONObject>() {
                ...
                public void onResponse(JSONObject response) {
                    ...
                    try {
                        ...
                        // => CreateAccountActivity => CreateAccountService
                        //Intent intent = new Intent(LoginActivity.this, CreateAccountActivity.class);

                        // => CreateAccountBoundActivity => CreateAccountBoundService
                        //Intent intent = new Intent(LoginActivity.this, CreateAccountBoundActivity.class);

                        // => CreateAccountJobActivity => CreateAccountJobService
                        //Intent intent = new Intent(LoginActivity.this, CreateAccountJobActivity.class);

                        // => CreateAccountMsgActivity => CreateAccountMsgService
                        Intent intent = new Intent(LoginActivity.this, CreateAccountMsgActivity.class);
